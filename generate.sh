...
./bin/configtxgen -profile MainChannel -outputAnchorPeersUpdate ./channel-artifacts/POCCreditRatingAgencyMSPanchors.tx -channelID $CHANNEL_NAME -asOrg POCCreditRatingAgencyMSP
